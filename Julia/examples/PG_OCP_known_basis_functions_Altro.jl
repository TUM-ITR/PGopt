...
# Solve the PG OCP.
# u_opt, x_opt, y_opt, J_opt, run_status, iter, iterations_outer, penalty_max = solve_PG_OCP_Altro(PG_samples, phi, R, H, u_min, u_max, y_min, y_max, R_cost_diag; K_pre_solve=20)
